...
<main class="d-flex h-100 justify-content-center">
<div class="d-flex flex-column align-items-center">
<h2>∙ 투표하기 ∙</h2>
<form id="form" method="post" action="${currentPath }/vote.do">
	<table>
		<tr>
			<th>주민번호</th>
			<td>
		...
		<tr>
			...
			<input type="button" id="submit-btn" class="btn btn-outline-dark" value="투표하기"/>
			<button class="btn btn-outline-dark" type="reset" onclick="fn_reset()">다시하기</button>
			</td>
		</tr>
	</table>
</form>
